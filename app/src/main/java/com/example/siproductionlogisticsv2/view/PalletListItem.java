...
public class PalletListItem extends FrameLayout {
    ...
    public PalletListItem(@NonNull Context context) {
        super(context);
        initInflate();
        iniIntance();
    }

    public PalletListItem(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        iniIntance();
    }

    public PalletListItem(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public PalletListItem(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initInflate() {
        inflate(getContext(), R.layout.pallet_list_item, this);
    }
